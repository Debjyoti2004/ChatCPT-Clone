...
export function ChatInput({
  ...
  return (
    <div className="sticky bottom-0 left-0 right-0 w-full bg-gradient-to-t from-[#1a1a1a] to-[#212121] backdrop-blur-xl z-10 border-t border-white/10">
      <div className="max-w-3xl sm:max-w-4xl mx-auto p-3 sm:p-4 md:p-6">
        ...
        <form onSubmit={onSubmit} className="relative">
          <div className="relative flex items-center bg-[#2f2f2f]/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl min-h-[56px] sm:min-h-[64px] md:min-h-[72px] px-3 sm:px-4 md:px-6 border border-white/20 shadow-2xl hover:shadow-3xl hover:border-white/30 transition-all duration-300">
            {/* Left side buttons */}
